...
***Raporttia täydennetty 11.10.2024***

### g) Salattua hallintaa

***Tätä tehtävää varten siirryin jälleen takaisin "pilvilinuxiin", eli Azuren pilvessä olevaan virtuaalikoneeseeni.***

Otin etäyhteyden virtuaalikoneeseeni tehdäkseni uuden käyttäjän. Otin yhteyden toistaiseksi ainoalla käyttäjällä, jolla on sudo-oikeudet.
<br></br>
<img width="566" alt="image" src="https://github.com/user-attachments/assets/5470b1a0-39b1-470a-9788-3837640e71a9">
<br></br>

Loin uuden käyttäjän komennolla `sudo adduser mathiaste01`. Lisäsin koko nimeni ja painoin enteriä muiden kyselyiden kohdalla.
<br></br>
<img width="536" alt="image" src="https://github.com/user-attachments/assets/926cccc6-0012-48fe-b087-955da19296b9">
<br></br>

Tämän jälkeen heitin itseni pihalle ja palasin vanhaan [raporttiini](https://github.com/Claptrack/Linux-palvelimet/blob/main/h5.md#c-pubkey), jossa käydään läpi kirjautumisen automatisoimista ssh-avaimella.

Loin uuden avainparin komennolla `ssh-keygen` ja määrittelin uuden nimen, koska toinen avain löytyi jo ennestään. (Kokeilin myös kopioida olemassa olevan avainparin toiselle käyttäjälle pilvilinuxissa, mutta sain vastaukseksi "permission denied", siksi loin uuden avainparin).
<br></br>
<img width="572" alt="image" src="https://github.com/user-attachments/assets/0ed3a03a-ebef-4ea5-baa6-c3c15d327418">
<br></br>

Sain tässä saman virheilmoituksen.
<br></br>
<img width="567" alt="image" src="https://github.com/user-attachments/assets/3a2dd1e8-35bc-4c38-8421-8c8cc437a2d6">
<br></br>

Valitettavasti en ehtinyt selvittää ongelmaa sen enempää, mutta epäilen sen liittyvän asetuksiin joita muutin aikaisemman tehtävän aikana. Jos aikaa olisi enemmän, kävisin läpi manuaalia ja konffitiedostoja. Käsitin Teron tunnilla että monen eri käyttäjän kirjautumisen automatisoimisen ei pitäis olla hankalaa, joten tässä ollaan ihan uuden ongelman edessä. Kokeilen tätä seuraavaksi labrassa käyttämäni Raspberry Pi:n kanssa ottamalla siihen etäyhteyden ja automatisoimalla muutaman käyttäjän kirjautumisen ilman muita muutoksia asetuksiin.
