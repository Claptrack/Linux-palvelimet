...
Etsin netistä ohjeita SSH-avaimen luomiseen ja päädyin DigitalOceanin [ohjeeseen](https://www.digitalocean.com/community/tutorials/how-to-set-up-ssh-keys-on-debian-11). Ohjeet näyttivät samalta, kuin mitä Tero demosi tunnilla.

Lähdin luomaan avainta komennolla 'ssh-keygen'. Painoin enter, jolloin avainpari tallentui /home/mathias.ssd -hakemistoon. Tämän jälkeen kävin generoimassa "tunnuslauseen" [täällä](https://www.useapassphrase.com), jonka syötin komentokehotteeseen. Avainpari oli nyt luotu ja tallennettu virtuaalikoneelleni.
